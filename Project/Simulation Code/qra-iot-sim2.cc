...
/*
 * NS-3 Standalone Simulation: Test Case 2 (Standard Small Scale)
 * Parameters: 25 Nodes, 128B Packets, 2.0 m/s Speed, 0.90 Threat Threshold.
 */
...
NS_LOG_COMPONENT_DEFINE ("QRA_IoT_TestCase2");

uint32_t g_processedPackets = 0;
double g_threatThreshold = 0.90;
...
int main (int argc, char *argv[])
{
    ...
    LogComponentEnable ("QRA_IoT_TestCase2", LOG_LEVEL_INFO);
    ...
    // ==========================================
    std::cout << "\n================================================================\n";
    std::cout << " TEST CASE 2: Standard Small Scale (25 Nodes, 2.0 m/s)\n";
    std::cout << "================================================================\n";
