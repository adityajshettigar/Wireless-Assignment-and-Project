...
/*
 * NS-3 Standalone Simulation: Test Case 3 (Mid-Density Baseline)
 * Parameters: 30 Nodes, 256B Packets, 3.0 m/s Speed, 0.85 Threat Threshold.
 */
...
NS_LOG_COMPONENT_DEFINE ("QRA_IoT_TestCase3");

// Global counters for the custom protocol filter
...
int main (int argc, char *argv[])
{
    ...
    LogComponentEnable ("QRA_IoT_TestCase3", LOG_LEVEL_INFO);
    ...
    // ==========================================
    std::cout << "\n================================================================\n";
    std::cout << " TEST CASE 3: Mid-Density Baseline (30 Nodes, 3.0 m/s)\n";
    std::cout << "================================================================\n";
