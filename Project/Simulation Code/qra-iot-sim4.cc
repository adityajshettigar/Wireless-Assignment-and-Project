...
/*
 * NS-3 Standalone Simulation: Test Case 4 (Increased Security Filtering)
 * Parameters: 35 Nodes, 256B Packets, 4.0 m/s Speed, 0.80 Threat Threshold.
 */
...
NS_LOG_COMPONENT_DEFINE ("QRA_IoT_TestCase4");

uint32_t g_processedPackets = 0;
double g_threatThreshold = 0.80; // 20% drop rate simulation

bool NetWatchdogFilter(Ptr<const Packet> packet) {
    g_processedPackets++; 
    Ptr<UniformRandomVariable> uv = CreateObject<UniformRandomVariable>();
    // If score > 0.80, packet is "malicious" and dropped
...
int main (int argc, char *argv[])
{
    ...
    for (auto const& [id, stat] : stats) {
        ...
        // Applying filter logic to every flow processed
    ...
    // ==========================================
    std::cout << "\n================================================================\n";
    std::cout << " TEST CASE 4: Increased Security Filtering (35 Nodes, 4.0 m/s)\n";
    std::cout << "================================================================\n";
