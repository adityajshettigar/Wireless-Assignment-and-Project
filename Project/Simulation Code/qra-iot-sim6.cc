...
/*
 * NS-3 Standalone Simulation: Test Case 6 (Strict Security / High Mobility)
 * Parameters: 45 Nodes, 512B Packets, 6.0 m/s Speed, 0.75 Threat Threshold.
 */
...
NS_LOG_COMPONENT_DEFINE ("QRA_IoT_TestCase6");

uint32_t g_processedPackets = 0;
double g_threatThreshold = 0.75; // Strict filter (drops 25% of traffic)
...
{
    // ==========================================
    // 1. PARAMETERS FOR TEST CASE 6
    // ==========================================
    uint32_t numNodes = 45;
    uint32_t packetSize = 512;
    double maxSpeed = 6.0;     // High mobility stress
    ...
    LogComponentEnable ("QRA_IoT_TestCase6", LOG_LEVEL_INFO);
    ...
    // ==========================================
    // 5. APPLICATIONS (Strict Filtering Flow)
    // ==========================================
    uint16_t port = 9;
    ...
    // ==========================================
    std::cout << "\n================================================================\n";
    std::cout << " TEST CASE 6: Strict Security / High Mobility (45 Nodes, 6.0 m/s)\n";
    std::cout << "================================================================\n";
